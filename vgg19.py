...
# Preprocessing transform, required for training and testing
...
def get_pretrained_vgg19(num_classes=10):
...
def train_pretrained_vgg19():        
    ...
    print('Model saved to vgg19_cifar10.pth')

    print('Finished Training')

def test_model():
    # Load the saved model state
    model = get_pretrained_vgg19(num_classes=10)
